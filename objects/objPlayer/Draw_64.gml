...
draw_text_transformed(CAMERA_WIDTH - 10, 115, $"Rolling: {rolling}", 0.5, 0.5, 0);
if (superspeed_time > 0) draw_text_transformed(CAMERA_WIDTH - 10, 133, $"Superspeed: {superspeed_time}", 0.5, 0.5, 0);
